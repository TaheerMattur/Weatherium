...
function init() {
  ...
  let apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=bangalore&units=metric&appid=${apiKey}`;
  axios.get(apiUrl).then(showTemperature);
  
  apiUrl = `https://api.openweathermap.org/data/2.5/forecast?q=bangalore&appid=${apiKey}&units=metric`;
...
function showTemperature(response) {
  ...
  /* A function to retrieve position of the user */
  ...
  function displayForecast(response) {
    ...
    /* Retriving the current position */
